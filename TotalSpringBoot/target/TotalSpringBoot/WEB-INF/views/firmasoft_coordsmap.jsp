		...
		<div class="page_header">
			<div class="form_container column_container">
				<div class="column column_4_1">
					<h3><spring:message code="koordinatHaritasi"/></h3>
				</div>
			</div>
		</div>
						...
						<div class="widget_content">
							<div class="form_container form_container_alternative">
								<div class="input_wrapper">
									<label><spring:message code="coorsLayer"/></label>
								</div>
								<br>
								<div class="input_wrapper">								
								<label for="phone"><spring:message code='koordinatTipi'/></label> 
								<select id="CoorType">
									<option value="1">DD MM SS.SSS</option>
									<option value="2">DDMMSS.SSS</option>
									<option value="3">DDMM.MMMMM</option>
									<option value="4" selected="">DD.DDDDDD</option>
								</select>
								</div>
								<br>
								<div class="input_wrapper">
									<label for="phone"><spring:message code='PosLatitude'/></label> 
									<input class="field forced"	data-mask="phone" data-key="phone" type="text" id="phone" placeholder="Ör: 41.01">								
								</div>
								<div class="input_wrapper">
									<label for="phone"><spring:message code='PosLongitude'/></label> 
									<input class="field forced"	data-mask="phone" data-key="phone" type="text" id="phone" placeholder="Ör: 29.02">								
								</div>
								<div class="button_container">
									<a href="javascript:;" class="button" onclick="koordsGoster();"><spring:message code="btnGit"/></a>
								</div>
						</div>
					</div>
				</div>
