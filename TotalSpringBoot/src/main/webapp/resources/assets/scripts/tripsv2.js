...
Trips.prototype.animateThemeClear = function () {
    /*var objStop = AdfPage.PAGE.findComponent("RgTrip:0:clhAnimateStop");
    objStop.setVisible(false);

    var objPlay = AdfPage.PAGE.findComponent("RgTrip:0:clhAnimatePlay");
    objPlay.setVisible(true);*/

	//$(".speedTextOverGraphic").text("Hız");
...
Trips.prototype.showEvents = function() {
    if(this.eventTheme.visible) {
     this.eventTheme.setVisible(false);
        ...
        this.eventTheme.setQueryParameters(cpTheQueryMode, this.mobile, cpTheQueryMode, this.mobile, cpTheEventGroupName, cpTheQueryMode, cpTheGroupname, cpTheQueryMode, cpTheGroupname, cpTheEventGroupName, cpTheQueryMode, cpTheEventCode, cpTheQueryMode, this.mobile, cpTheEventCode, cpTheQueryMode, cpTheGroupname, cpTheEventCode, this.startPosTimeStr, this.stopPosTimeStr, this.username);
        this.eventTheme.addListener(OM.event.MouseEvent.MOUSE_CLICK, tripsObject.eventsClick);
